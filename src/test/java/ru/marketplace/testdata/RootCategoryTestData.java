...
public class RootCategoryTestData {
    ...
    public static final RootCategory ROOT_CATEGORY1 = new RootCategory(ROOT_CATEGORY_ID, "goods");
    public static final RootCategory ROOT_CATEGORY2 = new RootCategory(ROOT_CATEGORY_ID + 1, "services");
    public static final RootCategory ROOT_CATEGORY3 = new RootCategory(ROOT_CATEGORY_ID + 2, "realty");
    ...
    public static final TestMatchers<RootCategory> ROOT_CATEGORY_MATCHERS = TestMatchers.useFieldsComparator(RootCategory.class, "offers");
}
